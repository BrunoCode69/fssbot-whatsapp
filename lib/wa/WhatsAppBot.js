...
const LIDMapper_1 = require("./LIDMapper");
...
class WhatsAppBot extends BotEvents_1.default {
    constructor(config) {
        ...
        this.lidMapper = new LIDMapper_1.LIDMapper();
    ...
    safeNormalizeJid(jid, lid) {
        ...
        try {
            ...
            (_b = (_a = this.logger) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.call(_a, 'Error normalizing JID/LID:', jid, lid, error);
            return undefined;
        }
    }
    /**
     ...
     */
    extractAndMapLID(message) {
        const key = message.key || {};
        // Extrai LID de participant (grupos) ou remoteJid
        const lid = (0, ID_1.getLIDFromMessage)(key);
    ...
    async getUserDescription(user) {
        ...
        if (!normalizedId)
            return '';
        const result = await this.sock.fetchStatus(normalizedId);
        return (Array.isArray(result) ? (_a = result[0]) === null || _a === void 0 ? void 0 : _a.status : result === null || result === void 0 ? void 0 : result.status) || '';
    }
