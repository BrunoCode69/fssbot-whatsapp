...
class ConvertWAMessage {
    ...
    async convertMessage(waMessage, type = "notify") {
        ...
        this.message.chat = new Chat_1.default((0, ID_1.fixID)(chatId, chatLid));
        ...
        if (waMessage.key.fromMe) {
            ...
            if (participantId) {
                userLid = (0, ID_1.getLIDFromMessage)({ participant: participantId });
        ...
        this.message.user = new User_1.default((0, ID_1.fixID)(userId, userLid || chatLid));
    }
    /**
    ...
    async convertContextMessage(context) {
        ...
        if (context.quotedMessage) {
            ...
            const message = {
                key: {
                    remoteJid: (0, ID_1.fixID)(quotedChatId, quotedLid),
    ...
    convertListMessage(content) {
        ...
        const listType = listMessage.listType;
        if (listType in ListMessage_1.ListType) {
            listMSG.listType = listType;
        }
        else {
            listMSG.listType = ListMessage_1.ListType.UNKNOWN;
        }
