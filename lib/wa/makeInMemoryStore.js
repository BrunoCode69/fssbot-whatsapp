                ...
                switch (type) {
                    ...
                    case 'notify':
                        for (const msg of newMessages) {
                            ...
                            const lid = (0, ID_1.getLIDFromMessage)(msg.key);
                            ...
                            if (messageId) {
                                ...
                                const existsInJid = (_a = messages[jid]) === null || _a === void 0 ? void 0 : _a.get(messageId);
                                const existsInLid = lid ? (_b = messages[lid]) === null || _b === void 0 ? void 0 : _b.get(messageId) : null;
                                if (existsInJid || existsInLid) {
                                    // Mensagem já existe, pula duplicação
                                    logger === null || logger === void 0 ? void 0 : logger.trace({ jid: storeKey, id: messageId }, 'message already exists, skipping duplicate');
                                    continue;
                                }
                            }
