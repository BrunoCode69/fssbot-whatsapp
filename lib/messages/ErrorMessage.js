...
class ErrorMessage extends Message_1.default {
     ...
     */
    constructor(chat, error = new Error(), others = {}) {
        super(chat, error.message);
        /** O tipo da mensagem é sempre MessageType.Error. */
        this.type = Message_1.MessageType.Error;
        this.error = error;
    ...
    static fromJSON(data) {
        return Message_1.default.fix(!data || typeof data != "object" ? new ErrorMessage() : (0, Generic_1.injectJSON)(data, new ErrorMessage()));
    }
    /**
    ...
    static isValid(message) {
        return Message_1.default.isValid(message) && (message === null || message === void 0 ? void 0 : message.type) == Message_1.MessageType.Error;
    }
}
