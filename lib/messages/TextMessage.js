...
class TextMessage extends Message_1.default {
    ...
    static fromJSON(data) {
        return Message_1.default.fix(!data || typeof data != "object" ? new TextMessage() : (0, Generic_1.injectJSON)(data, new TextMessage()));
    }
    /**
    ...
    static isValid(message) {
        return Message_1.default.isValid(message) && (message === null || message === void 0 ? void 0 : message.type) == Message_1.MessageType.Text;
    }
}
